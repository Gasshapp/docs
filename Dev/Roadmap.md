...
1. **Infrastructure OVH** — provisionner les ressources cloud (MKS, PostgreSQL Citus, Redis, vRack, Load Balancer)
2. **Wireframes** — définir toutes les pages et interactions avant de coder
3. **Tests** — mettre en place la stratégie de tests automatisés (voir `docs/TESTING_PLAN.md` dans le backend)
4. **Feature planning** — découper les fonctionnalités en epics et stories
